          ...
          <div key={film.film_id} className="card mb-4 shadow p-3">
            ...
            <div className="d-flex">
              ...
              <div>
                ...
                <h4 onClick={() => navigate(`/film/${film.film_id}`)}style={{ cursor: "pointer" }}onMouseEnter={(e) => e.target.style.color = "#ff7a00"}onMouseLeave={(e) => e.target.style.color = "black"}>{film.title}</h4>
